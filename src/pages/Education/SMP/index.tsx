...
export default function SMP() {
    ...
    return (
        <div className="flex flex-col gap-16 px-8 my-8">
            <Headline
                name={"SMP PONDOK PESANTREN Al-Khusyu’"}
                summary={"SMP Pondok Pesantren AL-KHUSYU merupakan lembaga yang memadukan kurikulum umum dan pendidikan Islam berbasis pesantren, guna membentuk generasi yang beriman, berilmu, berakhlak mulia."}
                imageList={imageList}
                teacherCount={25}
                studentCount={97}
            />
